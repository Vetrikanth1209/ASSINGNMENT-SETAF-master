...
export default function Tmoule() {
            ...
            <Table  sx={{ minWidth: 700 }} aria-label="sticky table" >
              <TableHead>
                <TableRow>
                  ...
                  <StyledTableCell>Taste Number</StyledTableCell>
                  <StyledTableCell>Seminar Topic</StyledTableCell>
                  <StyledTableCell>Resource Person Name</StyledTableCell>
              ...
              <TableBody>
                {data.map((row, index) => (
                  <StyledTableRow key={index}>
                    <StyledTableCell>{row.faculty_name}</StyledTableCell>
                    <StyledTableCell>{row.date}</StyledTableCell>
                    <StyledTableCell>{row.taste_number}</StyledTableCell>
                    <StyledTableCell>{row.seminar_topic}</StyledTableCell>
                    <StyledTableCell>{row.resource_person_name}</StyledTableCell>
